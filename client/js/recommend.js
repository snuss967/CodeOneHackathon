...
var getCompoundInterestAndSetMessage = function(numberOfYears, annualAddition) {
	...
	{
		$('#resultsSubtext').html("For a long term approach when you are not investing a significant amount of money. It is smart to stay diversified in an assortment of funds that have significant risk, but also a much more significant chance for high reward over the long term.");
		$('#resultsTitle').html("A Diversified Portfolio"); 
		return 0.12;
	}
